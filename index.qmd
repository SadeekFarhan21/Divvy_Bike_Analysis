...
```{r, sample_dataset, include=FALSE}
all_data <- all_data |> 
    sample_n(100)
```
...
```{r, ride_type_by_user, include=FALSE}
...
```{r, ride_type_by_rideable, include=FALSE}
...
```{r, average_ride_length, include=FALSE}
...
```{r, ride_length_by_weekday, include=FALSE}
...
```{r, total_rides_by_weekday, include=FALSE}
...
```{r, total_rides_by_hour, include=FALSE}
...
```{r, total_rides_by_month, include=FALSE}
