...
\setlength{\parindent}{0.2in} \setcounter{secnumdepth}{2} \setcounter{tocdepth}{2} % reduce paragraph indent a bit% no numbered subsubsections% no subsubsections in ToC
